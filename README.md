      ...
      <div class="container">
        ...
        <div class="cards-grid">
          ...
          <article class="card">
            ...
            <div class="card-body">
              <p>
                Iowa’s so-called “Right to Work” law is killing our communities one factory at a time. From Southeast Iowa to our
                neighbors to the south, we see the same pattern: closure after closure, jobs shipped away, and families left struggling.
              </p>
              <p>
                Meanwhile, Des Moines cuts unemployment benefits, adds waiting periods, and makes it harder for families to stay afloat
                after a layoff. That’s not leadership — that’s abandonment.
              </p>
              <ul>
                <li>Fight to protect and expand workers’ rights and collective bargaining.</li>
                <li>Oppose policies that weaken unemployment and punish laid-off workers.</li>
                <li>Support and attract employers who commit to good jobs and fair treatment.</li>
              </ul>
            </div>
          ...
          <article class="card">
            ...
            <div class="card-body">
              <p>
                Iowa used to lead the nation in education. We can get back there, but only if we stop treating public schools as a budget
                line item and start treating them as the backbone of our future.
              </p>
              <ul>
                <li>Fully fund public schools and support competitive pay for teachers.</li>
                <li>Protect special education, counselors, and support staff.</li>
                <li>Ensure rural and small-town schools have the resources they need.</li>
              </ul>
            </div>
            <div class="card-footer">
          ...
          <article class="card">
            ...
            <div class="card-body">
              <p>
                As a 100% disabled Army veteran and the father of a son with cochlear implants, I know how fragile healthcare access can be.
                Long drives, long waits, denied claims — families are stretched thin.
              </p>
              <ul>
                <li>Strengthen rural clinics and community health centers.</li>
                <li>Protect Medicaid and expand access to mental health services.</li>
                <li>Make sure families don’t have to choose between care and basic bills.</li>
              </ul>
            </div>
            <div class="card-footer">
              “Healthcare shouldn’t depend on your ZIP code, your employer, or your ability to fight paperwork for months on end.”
            </div>
          </article>
        </div>
      </div>
